      ...
      builder: (context, child, animation) {
        ...
        return Scaffold(
          ...
          bottomNavigationBar: BottomNavigationBar(
            ...
            items: const [
              BottomNavigationBarItem(label: 'Tümü', icon: Icon(Icons.checklist_rounded)),
              BottomNavigationBarItem(label: 'Tamamlanan', icon: Icon(Icons.check_circle_outline_rounded)),
              BottomNavigationBarItem(label: 'Tamamlanmamış', icon: Icon(Icons.radio_button_unchecked_rounded)),
            ],
          ),
        );
      },
